...
public class Menu extends PanelShadow {
    ...
    private void initData() {
        listMenu.addItem(new Model_Menu("1", "Dashboard Barang", Model_Menu.MenuType.MENU));
        listMenu.addItem(new Model_Menu("2", "Dashboard Gudang", Model_Menu.MenuType.MENU));
        listMenu.addItem(new Model_Menu("3", "Dashboard Supplier", Model_Menu.MenuType.MENU));
        listMenu.addItem(new Model_Menu("4", "Form Barang Masuk", Model_Menu.MenuType.MENU));
        listMenu.addItem(new Model_Menu("5", "Form Barang Keluar", Model_Menu.MenuType.MENU));
        listMenu.addItem(new Model_Menu("6", "Report Barang Masuk", Model_Menu.MenuType.MENU));
        listMenu.addItem(new Model_Menu("7", "Report Barang Keluar", Model_Menu.MenuType.MENU));
        listMenu.addItem(new Model_Menu("8", "Report Stok Barang", Model_Menu.MenuType.MENU));
        listMenu.addItem(new Model_Menu("9", "Report Data Supplier", Model_Menu.MenuType.MENU));
